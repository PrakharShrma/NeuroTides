        ...
        <div className='landingPage'>
            ...
            <main className="main">
                ...
                <section id="problem" className="xl-gap wf-section">
                    <div className="container w-container">
                        ...
                        <p>— <span className="cite">NeuroTides for Organizations</span> <br/> Employees' well-being directly impacts productivity, culture, retention, and healthcare costs. With NeuroTides employers can get job satisfaction, reduce absenteeism, and increase overall workforce productivity. Our application provides the accessible & convenient support employees need to be mentally healthy — so your people (and your business) can thrive.<br /><br />— <span className="cite">NeuroTides for Employees</span><br/>NeuroTides helps employees who are struggling with stress, anxiety, depression, or other mental health issues to manage their symptoms and improve their overall well-being. Our application provides employees with a comprehensive solution to reduce work stress, manage their mental health and well-being, and implement a positive work-life balance.<br /><br />— <span className="cite">NeuroTides for Individuals</span><br/>Individuals who aim to better their mental health and overall wellness, as well as establish positive habits, may utilize NeuroTides as a means to attain their objectives.<span className="cite"></span></p>
                    </div>
                </section>
                ...
                <section id="EAP" className="relative xxl-gap wf-section">
                    ...
                    <div className="container w-container">
                        <h2>Expand your EAP with NeuroTides</h2>
                        <p>Employee Assistance Programs (EAPs) are an essential component of many organizations' benefits packages, providing employees with access to resources and support for a range of personal and work-related issues. NeuroTides is a digital mental health platform that provides the facility of online therapy and counseling services to individuals and organizations. The application offers a range of benefits that can complement and expand on existing EAP services<br /><br />— <span className="cite">NeuroTides for Employee Assistance Programs</span><span className="cite"></span></p>
                    </div>
                </section>
            </main>
            ...
            <footer className="footer wf-section">
                ...
                <div className="container footer w-container">
                    ...
                    <div className="w-layout-grid grid-three">
                        <div>
                            <a href="tel:(+91) 9XXXXXXXXX" className="footer-link">‭(+91) 9XXXXXXXXX</a>
                            <a href="mailto:hello@NeuroTides.live"
                                className="footer-link">hello@NeuroTides.live</a>
                        </div>
                        <div>©NeuroTides<br />Bangalore Institue Of Technology</div>
                    </div>
                </div>
            </footer>
        </div>
